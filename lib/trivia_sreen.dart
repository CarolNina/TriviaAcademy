...
class TriviaSreen extends StatefulWidget {
  @override
  _TriviaSreenState createState() => _TriviaSreenState();
}

class _TriviaSreenState extends State<TriviaSreen> {
  int answer = 0;
  int score = 0;
  int index = 0;
  List<Question> questionsList = Question.getQuestonsList();
